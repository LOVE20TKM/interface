    ...
    <div className="mt-6 bg-greyscale-50 rounded-lg p-4">
      ...
      <div className="space-y-3">
        ...
        <div className="md:max-w-2xl">
          ...
          <div className="font-mono text-data-public text-sm md:text-base">{waitingBlocks.toString()}</div>
        </div>
        ...
        <div className="md:max-w-2xl">
          ...
          <div className="text-xs text-greyscale-600">有效LP占比超过 (治理票占比 × 治理比率乘数) 的部分，不再有收益</div>
        </div>
      </div>

      {/* 说明文字 */}
      {/* <div className="mt-4 text-xs md:text-sm text-greyscale-600 space-y-1">
