    ...
    >
      <div className="bg-card rounded-lg p-6 w-full max-w-md text-center shadow-xl">
        ...
        <textarea
          ...
          value={text}
          readOnly
          className="w-full h-32 p-3 border border-greyscale-300 rounded-md font-mono text-sm resize-none mb-4 bg-greyscale-50 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
        />
        ...
        {autoCloseDelay > 0 && (
          <p className="text-xs text-greyscale-500 mt-3">{Math.round(autoCloseDelay / 1000)} 秒后自动关闭</p>
        )}
      </div>
    </div>
  );
