      ...
      <main className="flex-grow bg-card">
        ...
        <div className="flex flex-col w-full p-4">
          <div className="bg-status-info-soft border-l-4 border-l-status-info-border rounded-r-lg p-4 mb-8 text-sm">
            ...
            <div className="text-base font-bold text-status-info pt-2 pb-1">SL代币：</div>
            <div className="text-sm text-status-info">
              代币对儿由质押合约注入 Uniswap V2 流动性池，并铸造SL代币作为流动性质押凭证
            </div>

            <div className="text-base font-bold text-status-info pt-2 pb-1">治理票：</div>
            <div className="text-sm text-status-info">所得治理票数 = SL代币数量 * 解锁期阶段数</div>
            <div className="text-base font-bold text-status-info pt-2 pb-1">治理激励：</div>
            <div className="text-sm text-status-info pb-1">1、当轮所得治理激励 = 验证激励 + 加速激励</div>
            <div className="text-sm text-status-info pb-1">
