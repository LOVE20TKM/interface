      ...
      <main className="flex-grow px-3 sm:px-0">
        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full max-w-2xl mx-auto">
          ...
          <TabsContent value="swap">
            ...
            <div className="bg-status-success-soft border-l-4 border-l-status-success-border rounded-r-lg p-2 mb-8 text-sm mt-0 mx-2 sm:mx-6">
              <div className="flex items-center gap-2 text-base font-bold text-status-success pb-2">
                <HelpCircle className="w-4 h-4" />
                小贴士
              </div>
              <div className="text-base font-bold text-status-success pt-2 pb-1">费用说明：</div>
              <div className="text-sm text-status-success">手续费为 0.3%，滑点上限为 0.5%</div>
              <div className="text-base font-bold text-status-success pt-2 pb-1">交易协议：</div>
              <div className="text-sm text-status-success">本交易功能基于 Uniswap V2 协议实现，合约代码为官方最新版本</div>
            </div>
          </TabsContent>
          ...
          <TabsContent value="liquidity">
            ...
            <div className="bg-status-success-soft border-l-4 border-l-status-success-border rounded-r-lg p-2 mb-8 text-sm mt-0 mx-2 sm:mx-6">
              ...
              <div className="text-base font-bold text-status-success pt-2 pb-1">添加流动性：</div>
              <div className="text-sm text-status-success">
                添加流动性后可获得 LP 代币，并参与交易手续费分成(手续费为 0.3%)
              </div>
              <div className="text-base font-bold text-status-success pt-2 pb-1">LP代币：</div>
              <div className="text-sm text-status-success">添加流动性后将获得 LP 代币，代表您在流动性池中的份额</div>
              <div className="text-base font-bold text-status-success pt-2 pb-1">交易协议：</div>
              <div className="text-sm text-status-success">本交易功能基于 Uniswap V2 协议实现，合约代码为官方最新版本</div>
            </div>
          </TabsContent>
