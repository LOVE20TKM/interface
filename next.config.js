...
const nextConfig = {
  ...
  async exportPathMap() {
    return {
      ...
      '/apps': { page: '/apps' },
      '/apps/batch-transfer': { page: '/apps/batch-transfer' },
      '/chat': { page: '/chat' },
      '/chat/activate': { page: '/chat/activate' },
      '/chat/activate/chain': { page: '/chat/activate/chain' },
      '/chat/activate/token-action-gov-manager': { page: '/chat/activate/token-action-gov-manager' },
      '/chat/activate/token-action-main-manager': { page: '/chat/activate/token-action-main-manager' },
      '/chat/activate/token-gov-manager': { page: '/chat/activate/token-gov-manager' },
      '/chat/activate/token-main-manager': { page: '/chat/activate/token-main-manager' },
      '/chat/group': { page: '/chat/group' },
      '/chat/group/admins': { page: '/chat/group/admins' },
      '/chat/group/ban-voters': { page: '/chat/group/ban-voters' },
      '/chat/group/banlist': { page: '/chat/group/banlist' },
      '/chat/group/members': { page: '/chat/group/members' },
      '/chat/group/mentions/all': { page: '/chat/group/mentions/all' },
      '/chat/group/mentions/me': { page: '/chat/group/mentions/me' },
      '/chat/group/message': { page: '/chat/group/message' },
      '/chat/group/sender': { page: '/chat/group/sender' },
      '/chat/group/settings': { page: '/chat/group/settings' },
      '/chat/preferences': { page: '/chat/preferences' },
      '/dex': { page: '/dex' },
      ...
      '/extension/my_groups': { page: '/extension/my_groups' },
      '/group/mint': { page: '/group/mint' },
      ...
      '/my/queryaction': { page: '/my/queryaction' },
